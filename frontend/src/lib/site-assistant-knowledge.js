...
const TOPICS = [
  ...
  },
  {
    ...
    text:'Choose the smallest workflow that creates a real business result this week. AgentForge currently has three complete, approval-gated starter kits.',
    bullets:[
  ...
  },
  {
    ...
    text:'AgentForge includes typed workflow actions for communication, CRM, commerce, productivity, support, engineering, and data systems, plus universal HTTP and signed webhooks.',
    bullets:['Typed actions cover Slack, Google, GitHub, Discord, Notion, Airtable, HubSpot, Salesforce, Stripe, Shopify, Jira, Linear, Twilio, Zendesk, Resend, and Supabase.', 'Manual provider credentials are stored in the encrypted vault.', 'Test a credential and keep consequential actions approval-gated before production.'],
