...
const TOPICS = [
  ...
  },
  {
    ...
    text:'Live workflow actions include HTTP requests, Resend email, Slack messages, Google Sheets append, Google Drive file creation, and selected Supabase database operations.',
    bullets:['Slack and Google can use OAuth when provider configuration is available.', 'Manual provider credentials are stored in the encrypted vault.', 'Test a credential before attaching it to production work.'],
